...
void I_GetEvent(void)
{
        ...
        if (kUpPC & CLASSIC_CTRL_BUTTON_X)     XButton = 0;
        if (kUpPC & CLASSIC_CTRL_BUTTON_Y)     YButton = 0;
        if (kUpPC & CLASSIC_CTRL_BUTTON_UP)    Up = 0;
        if (kUpPC & CLASSIC_CTRL_BUTTON_DOWN)  Down = 0;
        ...
        float rawPC_X = (float)WUPC_lStickX(0);           // –1024…+1024;
        float rawPC_Y = (float)WUPC_lStickY(0);
        ...
        const float pcDZ = 15.0f/1024.0f;
